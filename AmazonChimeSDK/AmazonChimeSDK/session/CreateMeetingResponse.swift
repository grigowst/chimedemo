...
@objcMembers public class MediaPlacement: NSObject {
    ...
    public init(audioFallbackUrl: String, audioHostUrl: String, screenDataUrl: String, screenSharingUrl: String, screenViewingUrl: String, signalingUrl: String, turnControlUrl: String) {
